...
SECRET_KEY = 'django-insecure-i34ho7l_@g0o5jv%z(#&b40=0(wamdd_^t4fm7)pt4s4bo^o2i'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'DESKTOP-7HV7BNG',  # Your server name without the instance part
        'PORT': '',  # Typically empty for named instances
        'OPTIONS': {
            'driver': 'ODBC Driver 17 for SQL Server',
            'trusted_connection': 'yes',  # This enables Windows Authentication
            'server': 'DESKTOP-7HV7BNG\\SQLEXPRESS',  # Named instance
        },
    }
}
